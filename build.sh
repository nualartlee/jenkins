...
# Initial setup of the YouTube Comment Scraper service
# Creates databases, passwords and keys

# Print header
clear
echo "====================================="
echo "YouTube Comment Scraper Initial Setup"
echo
...
docker-compose -f docker-compose-development.yml run scrapyd ./scrapyd_setup.sh

# Run Django setup
echo
echo "Running django_setup.py"
docker-compose -f docker-compose-development.yml run django python3 django_setup.py
